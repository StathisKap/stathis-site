import { c as create_ssr_component, v as validate_component, i as is_promise, n as noop, h as is_void } from './index-d4538545.js';
...
const Typewriter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const modes = {
    concurrent: () => import('./concurrent-97d5b861.js'),
    cascade: () => import('./cascade-9be9b9d0.js'),
    loop: () => import('./loop-7a669042.js'),
    loopOnce: () => import('./loopOnce-9dfe9857.js'),
    loopRandom: () => import('./loopRandom-b5d74ad3.js'),
    scramble: () => import('./scramble-3ed6a670.js')
  };
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"text-lg"}"><table><tr><td class="${"pr-1"}">$</td>
			<div style="display: contents; --cursor-color:${"#d3e5f5"};">${validate_component(Typewriter, "Typewriter").$$render($$result, { interval: 300, delay: 1e3 }, {}, {
    default: () => {
      return `<td class="${"font-Menlo"}">whoami</td>`;
    }
  })}</div>
			${``}</tr></table></div>
...
//# sourceMappingURL=_page.svelte-8a169e56.js.map
